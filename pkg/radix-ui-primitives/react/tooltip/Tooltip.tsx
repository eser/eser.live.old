...
const [TooltipContextProvider, useTooltipContext] = createTooltipContext<
  TooltipContextValue
>(TOOLTIP_NAME);
...
const Tooltip: React.FC<TooltipProps> = (props: ScopedProps<TooltipProps>) => {
  ...
  const disableHoverableContent = disableHoverableContentProp ??
  ...
  const stateAttribute = React.useMemo(() => {
    return open
      ? (wasOpenDelayedRef.current ? "delayed-open" : "instant-open")
      : "closed";
  }, [open]);
...
const [PortalProvider, usePortalContext] = createTooltipContext<
  PortalContextValue
>(PORTAL_NAME, {
...
>((props: ScopedProps<TooltipContentHoverableProps>, forwardedRef) => {
  ...
  const [pointerGraceArea, setPointerGraceArea] = React.useState<
    Polygon | null
  >(null);
