...
const [MenubarContextProvider, useMenubarContext] = createMenubarContext<
  MenubarContextValue
>(MENUBAR_NAME);
...
const [MenubarMenuProvider, useMenubarMenuContext] = createMenubarContext<
            ...
            <Primitive.button
              ...
              onPointerDown={composeEventHandlers(
                ...
                (event) => {
                  ...
                  if (
                    !disabled && event.button === 0 && event.ctrlKey === false
                  ) {
        ...
        onKeyDown={composeEventHandlers(
          ...
          (event) => {
            if (["ArrowRight", "ArrowLeft"].includes(event.key)) {
              ...
              const prevMenuKey = context.dir === "rtl"
                ? "ArrowRight"
                : "ArrowLeft";
